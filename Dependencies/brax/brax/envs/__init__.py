...
from brax.envs import antv
from brax.envs import half_cheetahv
from brax.envs import hopperv
from brax.envs import humanoidv

from brax.envs import half_cheetah_vel
from brax.envs import ant_dir
from brax.envs import hopper_vel
from brax.envs import humanoid_vel
from brax.envs import humanoid_dir
from brax.envs import swimmer_dir
from brax.envs import swimmer_vel
from brax.envs import walker2d_vel
...
_envs = {
    ...
    'antv': functools.partial(antv.Antv, use_contact_forces=True),
    'halfcheetahv': half_cheetahv.Halfcheetahv,
    'hopperv': hopperv.Hopperv,
    'humanoidv': humanoidv.Humanoidv,

    'halfcheetah_vel': half_cheetah_vel.HalfcheetahVel,
    'ant_dir': ant_dir.AntDir,
    'hopper_vel': hopper_vel.HopperVel,
    'humanoid_vel': humanoid_vel.HumanoidVel,
    'humanoid_dir': humanoid_dir.HumanoidDir,
    'swimmer_dir': swimmer_dir.SwimmerDir,
    'swimmer_vel': swimmer_vel.SwimmerVel,
    'walker2d_vel': walker2d_vel.Walker2dVel
}
