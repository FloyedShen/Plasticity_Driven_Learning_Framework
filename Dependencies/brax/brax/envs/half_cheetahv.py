...
# Datetime  : 2023/2/3 22:49
# User      : yu
# Product   : PyCharm
# Project   : brax
# File      : half_cheetahv.py
# explain   :
...
class Halfcheetahv(env.Env):
  ...
  * v0: Initial versions release (1.0.0)
  ...
  def reset(self, rng: jp.ndarray) -> env.State:
    ...
    return env.State(qp, obs[6:18], reward, done, metrics)
  ...
  def step(self, state: env.State, action: jp.ndarray) -> env.State:
    ...
    return state.replace(qp=qp, obs=obs[6:18], reward=reward)
